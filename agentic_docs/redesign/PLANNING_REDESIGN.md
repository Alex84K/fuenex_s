...
| 6 | Лендинг не изменился ничем | **закрыт — но обратным решением.** По запросу 17 августа лендинг переведён на палитру дизайн-системы и имя Stroylit (`DESIGN` §5.4, §8) |
